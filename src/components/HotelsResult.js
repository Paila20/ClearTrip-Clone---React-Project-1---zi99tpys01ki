        ...
        <div className='innernav'>
          ...
          <div className='HotelsResultDownNav flexja'>
            ...
            <div className="hotelsresult-price flexa" onClick={() => { popp("price") }}>
              <svg width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.8 6.91C12.8 10.726 8 14 8 14s-4.8-3.273-4.8-7.09c0-1.303.506-2.552 1.406-3.472A4.747 4.747 0 0 1 8 2c1.273 0 2.494.517 3.394 1.438.9.92 1.406 2.17 1.406 3.471Z" stroke="#1A1A1A" strokeLinecap="round" strokeLinejoin="round"></path><path d="M8 8.6A1.8 1.8 0 1 0 8 5a1.8 1.8 0 0 0 0 3.6Z" stroke="#1A1A1A" strokeLinecap="round" strokeLinejoin="round"></path></svg>
              <p>Price:</p>
              <pre>{filter["pricelow"]}    {filter["pricehigh"]}</pre>
              &nbsp;&nbsp;<svg width="14" height="9" fill="currentColor" className={`t-all ml-3 ${pop["price"] ? "rotateButtonzero" : "rotateButtonOneNinty"}`} style={{ color: "rgb(153, 153, 153)", transform: "rotate(-180deg)" }}><g fill="none" fillRule="evenodd"><path d="M15 12H-1V-4h16z"></path><path stroke="#FFF" strokeWidth="0.5" fill="currentColor" d="M11.59 8L7 3.42 2.41 8 1 6.59l6-6 6 6z"></path></g></svg>
              {pop["price"] && <div className='hotelsresult-price-pop flex flexc g20' onClick={(e) => { e.stopPropagation(); }}>
                ...
                <MultiRangeSlider min={1000} max={10000} minValue={filter["pricelow"]} ruler="false" label="false" maxValue={filter["pricehigh"]} step={1} onInput={(e) => { minrangesetter(e.minValue); maxrangesetter(e.maxValue) }} />
              </div>}
            </div>
          </div>
