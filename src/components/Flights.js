...
export default function Flights() {
  ...
  const [flightInOutPop, setflightInOutPop] = useState({
    in: false,
    out: false,
  });
  ...
  const [dayre, setdayre] = useState(
    activeReDate ? daysOfWeek[datere.getDay()] : ""
  );
  const [monthre, setmonthre] = useState(
    activeReDate ? months[datere.getMonth()] : ""
  );
  ...
  function dateprintgo() {
    ...
    if (activeReDate) {
      if (
        datere.getMonth() + 1 < datego.getMonth() + 1 ||
        (datere.getMonth() + 1 === datego.getMonth() + 1 &&
          datere.getDate() < datego.getDate())
      ) {
        setdatere(datego);
        dateprintre();
      }
  ...
  function getFlights() {
    if (flightIn && flightOut) {
      navigate(
        `/flights/results?flightfrom=${flightIndata.name}&flightto=${flightOutdata.name}&dayofweek=${datego}`
      );
    }
  }
  ...
  function forbuttonDisable() {
    {
      Object.keys(objfares).map((item) => {
        document.getElementsByClassName(objfares[item])[0].style.color =
          "black";
        document.getElementsByClassName(objfares[item])[0].style.border =
      ...
      document.getElementsByClassName(`${fare}`)[0].style.border =
        "1px solid #3366CC";
      document.getElementsByClassName(`${fare}`)[0].style.backgroundColor =
        "#3366cc19";
    }
    {
    ...
    if (rotateButtonPeople) {
      {
        ...
        adult == 1
          ? ((minbutton.style.color = "gray"),
            (minbutton.style.border = "1px solid gray"))
          : ((minbutton.style.color = "#3366CC"),
            (minbutton.style.border = "1px solid #3366CC"));
        children == 0
          ? ((minnbutton.style.color = "gray"),
            (minnbutton.style.border = "1px solid gray"))
          : ((minnbutton.style.color = "#3366CC"),
            (minnbutton.style.border = "1px solid #3366CC"));
        infant == 0
          ? ((minnnbutton.style.color = "gray"),
            (minnnbutton.style.border = "1px solid gray"))
          : ((minnnbutton.style.color = "#3366CC"),
            (minnnbutton.style.border = "1px solid #3366CC"));
      }

      {
        Object.keys(objcolor).map((item) => {
          document.getElementsByClassName(objcolor[item])[0].style.color =
            "black";
          document.getElementsByClassName(objcolor[item])[0].style.border =
            "0.5px solid lightgray";
        });
        document.getElementsByClassName(`${classFlight}`)[0].style.color =
          "#3366CC";
        document.getElementsByClassName(`${classFlight}`)[0].style.border =
          "1px solid #3366CC";
      }
    }
  }
  ...
  return (
    <div className="flightpage flex">
      <div className="mainFlightPage">
        ...
        <h4 className="flightMainHeadingBottom">
          Airline Sale is live!
          <br className="flightMainHeadingBottomMoverNextLine" /> Domestic fare
          starting at ₹1,799*
        </h4>
        <div className="flightSearchform flex flexc">
          <div className="formselectorWayClass flexa">
            <div
              className="wayDefine flexja"
              onClick={() => {
                setrotateButtonWay(!rotateButtonWay);
                setrotateButtonPeople(false);
              }}
            >
              {ways == "one" ? (
                <p className="flexja">
              ...
              <svg
                ...
                height="9"
                fill="currentColor"
                className={`t-all ml-3 ${
                  rotateButtonWay ? "rotateButtonzero" : "rotateButtonOneNinty"
                }`}
                style={{
              ...
              {rotateButtonWay && (
                <div className="wayChooser flexa">
                  <p
                    onClick={() => {
                      setways("one");
                      setactiveReDate(false);
                    }}
                    className="flexja hov"
                  >
                    {ways == "one" && (
                      <svg
                        width="24"
            ...
            <div className="peoplepop">
              <div
                className="peopleForTrip flexja"
                onClick={() => {
                  setrotateButtonPeople(!rotateButtonPeople);
                  setrotateButtonWay(false);
                }}
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <mask
                ...
                <p>
                  ...
                  {classFlight == "First" || classFlight == "Bussiness"
                    ? `${classFlight} className`
                    : classFlight == "Premium"
                    ? `${classFlight} economy`
                    : classFlight}
                </p>
                ...
                <div className="peopleChooser flexa">
                  ...
                  <div className="peopleClasses">
                    <div className="upperClassesdiv flexa">
                      <p
                        className="flexja Economy"
                        onClick={() => setclassFlight("Economy")}
                      >
                        Economy
                      </p>
                      <p
                        className="flexja Bussiness"
                        onClick={() => setclassFlight("Bussiness")}
                      >
                        Bussiness className
                      </p>
                      <p
                        className="flexja First"
                        onClick={() => setclassFlight("First")}
                      >
                        First className
                      </p>
                    </div>
                    <div className="downClassesdiv">
                      <p
                        className="Premium"
                        onClick={() => setclassFlight("Premium")}
                      >
                        Premium economy
                      </p>
                    </div>
          ...
          <div className="fares flex">
            <div className="faresl flexja">
              <p
                className="Regular_fare"
                onClick={() => setfare("Regular_fare")}
              >
                Regular fare
              </p>
              <p
                className="Student_fare"
                onClick={() => setfare("Student_fare")}
              >
                Student fare
              </p>
            </div>
            <div className="faresr flexja">
              <p
                className="Senior_citizen_fare"
                onClick={() => setfare("Senior_citizen_fare")}
              >
                Senior citizen fare
              </p>
              <p
                className="Armed_forces_fare"
                onClick={() => setfare("Armed_forces_fare")}
              >
                Armed forces fare
              </p>
            </div>
            ...
            <div className="flex flexc g5">
                ...
                <div className="flexa">
                  <div className="ii1 flexa">
                    ...
                    <input
                      type="text"
                      value={flightIn}
                      onChange={(e) => handleFlightChangeIn(e)}
                      placeholder="Where from?"
                    />
                    {flightInOutPop["in"] == true && searchedcityIn.length > 0 ? (
                      <div className="flightInData flexa flexc">
                        {searchedcityIn.map((item, index) => (
                          <div
                            className="slidee flexja"
                            key={index}
                            onClick={() => {
                              setflightIn(`${item.name} - ${item.fname}`);
                              setflightIndata(item);
                              setflightInOutPop({"in": false})
                            }}
                          >
                            <p>{item.name}</p>
                            <h4>
                ...
                <div className="i2 flexa">
                  <div className="ii2 flexa">
                    ...
                    <input
                      type="text"
                      value={flightOut}
                      onChange={(e) => handleFlightChangeOut(e)}
                      placeholder="Where to?"
                    />
                    {flightInOutPop["out"] == true && searchedcityOut.length > 0 ? (
                      <div className="flightInData flexa flexc">
                        {searchedcityOut.map((item, index) => (
                          <div
                            ...
                            key={index}
                            onClick={() => {
                              setflightOut(`${item.name} - ${item.fname}`);
                              setflightOutdata(item);
                              setflightInOutPop({"out": false})
                            }}
                          >
                            <p>{item.name}</p>
                            <h4>
              ...
              {samefield && (
                <span className="error">
                  Departure and arrival airports / cities cannot be same.
                </span>
              )}
            </div>
          </div>
          <div className="DateandButtonOuter flex">
            <div className="DateandButtonInner flexa">
              <div className="datePicker flexa">
                <div
                  className="leftDatePicker flexa"
                  onClick={() => {
                    setdatePop({ go: true, re: false });
                  }}
                >
                  ...
                  {datePop.go && (
                    <Calendar
                      ...
                      value={datego}
                      className="calendarForGoing"
                    />
                  )}
                </div>
                <div
                  className="rightDatePicker flexja"
                  onClick={() => {
                    setdatePop({ go: false, re: true });
                  }}
                >
                  <div className={`datesReturn ${!activeReDate && "blur"}`}>
                    {activeReDate
              ...
              <button
                className={`${
                  !flightIn || !flightOut || samefield ? "buttondisabled" : ""
                }`}
                style={{ marginRight: 40, marginLeft: 10 }}
                onClick={() => getFlights()}
                disabled={!flightIn || !flightOut || samefield}
              >
                Search flights
              </button>
            </div>
